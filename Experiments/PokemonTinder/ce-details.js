customElements.define('tindertarot-details', class extends HTMLElement {
  constructor() {
    super();
    this._carousel = this.querySelector('tindertarot-carousel');
  }
  ...
  _updateBindings() {
    ...
    this.querySelector('.item__details__distance').textContent = `${this.data.distance} generation`;
